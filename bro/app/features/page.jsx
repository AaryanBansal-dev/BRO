...
const page = () => {
  return (
    <div>
      ...
      <p className="px-24 text-lg text-slate-400">
        ...
        <p className="px-24 text-lg text-slate-400">The multi-functional rescue arm is a robotic tool designed to reach narrow and confined spaces like borewells. It can:</p>
        <ul className='px-24 text-lg py-2 text-slate-400'>
        ...
        <p className="px-24 text-lg text-slate-400">Safe and efficient extraction ensures the child is removed without causing harm. This includes:</p>
        <ul className='px-24 text-lg py-2 text-slate-400'>
        ...
        <p className="px-24 text-lg text-slate-400">AI helps automate decision-making during the rescue operation, improving precision and speed. It can:</p>
        <ul className='px-24 text-lg py-2 text-slate-400'>
